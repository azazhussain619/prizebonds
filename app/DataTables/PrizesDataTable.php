...
class PrizesDataTable extends DataTable
{
    /**
     ...
     */
    public function query(Prize $model): QueryBuilder
    {
        return $model::with('denomination')->select('prizes.*');
    }
