                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('posts.update', $post->id) }}" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-12">
                                <x-forms.input name="title" :value="$post->title" required/>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6 px-0">
                                ...
                                <div class="col-md-12">
                                    <x-forms.input name="slug" :value="$post->slug" required/>
                                </div>
                            </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-12">
                                <textarea id="summernote" name="content"
                                          class="form-control @error( 'content' ) is-invalid @enderror" required>{{ $post->content }}</textarea>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-12">
                                <x-forms.textarea name="excerpt" required :value="$post->excerpt"></x-forms.textarea>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div>
                                <img class="mb-2" height="100px"
                                     src="{{ asset('storage/featured-images/'.$post->featured_image) }}"/>
                            </div>
