        ...
        <div class="container-fluid">
            <div class="card card-success">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('draw-results.store') }}">
                        @csrf
                        <div class="row mb-3">
                            <label for="name"
                        ...
                        <div class="row mb-3">
                            <label for="price"
                                   class="col-md-12 col-form-label text-md-start">{{ __('Select number of 1st Prizes') }}</label>

                            <div class="col-md-12">
                                <x-forms.input type="number" value="1" name="no_of_first_prizes" required/>
                            </div>
                        </div>

                        <div class="row mb-3">
                            <label for="price"
                                   class="col-md-12 col-form-label text-md-start">{{ __('Select number of 2nd Prizes') }}</label>

                            <div class="col-md-12">
                                <x-forms.input type="number" value="3" name="no_of_second_prizes" required/>
                            </div>
                        </div>
